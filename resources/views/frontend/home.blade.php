                    ...
                    <div>
                        <div class="col-xs-12">
                            ...
                            <article class="profileColumn hasOver">
                                ...
                                <div class="textWrap">
                                    <h2 class="fontNeuron text-capitalize"><a href="agent-detail.html">Veronica
                                            Green</a></h2>
                    ...
                    <div>
                        <div class="col-xs-12">
                            ...
                            <article class="profileColumn hasOver">
                                ...
                                <div class="textWrap">
                                    <h2 class="fontNeuron text-capitalize"><a href="agent-detail.html">Guti
                                            Salvio</a>
                                    </h2>
                    ...
                    <div>
                        <div class="col-xs-12">
                            ...
                            <article class="profileColumn hasOver">
                                ...
                                <div class="textWrap">
                                    <h2 class="fontNeuron text-capitalize"><a href="agent-detail.html">Elenia
                                            Jesse</a>
                                    </h2>
                    ...
                    <div>
                        <div class="col-xs-12">
                            ...
                            <article class="profileColumn hasOver">
                                ...
                                <div class="textWrap">
                                    <h2 class="fontNeuron text-capitalize"><a href="agent-detail.html">Emmy
                                            Ramos</a>
                                    </h2>
