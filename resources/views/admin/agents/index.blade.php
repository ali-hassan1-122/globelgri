    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="" type="button" class="btn btn-sm btn-info text-white" data-toggle="tooltip"
                        title="View User">
                        <i class="fa fa-eye"></i>
                    </a>
                    <a href="{{route('admin.user.edit' , ['id'=>$user->id])}}" type="button"
                        class="btn btn-sm btn-primary text-white" data-toggle="tooltip" title="Edit User">
                    ...
                    @if ($user->status == 0)
                    <a href="{{route('admin.user.unban' , ['id'=>$user->id])}}" class="btn btn-sm btn-success"
                        data-toggle="tooltip" title="UnBan User">
                        <i class="fa fa-unlock"></i>
                    </a>
                    @else
                    <a href="{{route('admin.user.ban' , ['id'=>$user->id])}}" class="btn btn-sm btn-dark"
                        data-toggle="tooltip" title="Ban User">
                        <i class="fa fa-ban"></i>
                    </a>
                    @endif
